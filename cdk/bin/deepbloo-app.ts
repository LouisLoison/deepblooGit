...
import { ProcessStepsStack } from '../lib/process-steps-stack';
...
const processStack = new ProcessStepsStack(app, 'DocumentProcessStack', {
...
new ImportsStepsStack(app, 'TenderImportStack', {
  env: { account: "669031476932", region:   "eu-west-1" },
  //  nodeLayerArn: textractPipelineStack.nodeLayerArn,
});