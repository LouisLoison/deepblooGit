...
export class ImportsStepsStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const processDocumentArn = ''
    const documentProcessId = "DocumentProcessTask"
    ...
    const stepFunctionsTask = new StepFunctionsStartExecution(this, documentProcessId, {
    ...
    const documentProcessStateMachine = new StateMachine(this, "SampleStateMachine", {
      ...
      .next(new Choice(this, 'Has interest ?')
        ...
        .otherwise(stepTenderIndexTask
          .next(new Choice(this, 'Has documents ?')
            .when(Condition.booleanEquals('$.mergedData.hasDocuments', true)
              .next(documentProcessStateMachine)
              .next(fullSucceed)
