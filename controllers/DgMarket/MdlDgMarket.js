exports.BddImport = () => {
  return new Promise(async (resolve, reject) => {
    const tenders = await this.FileParse()
  ...
  return new Promise(async (resolve, reject) => {
    ...
    parseData.notices.notice.forEach(notice => {
      ...
      tenders.push({
        ...
        contactAddress: tool.getXmlJsonData(notice.contactAddress[0].address),
        contactCity: tool.getXmlJsonData(notice.contactAddress[0].city),
        contactState: tool.getXmlJsonData(notice.contactAddress[0].state),
        contactCountry: tool.getXmlJsonData(notice.contactAddress[0].country),
        contactEmail: tool.getXmlJsonData(notice.contactAddress[0].email),
        contactPhone: tool.getXmlJsonData(notice.contactAddress[0].phone),
